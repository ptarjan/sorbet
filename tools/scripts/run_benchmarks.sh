...
./bazel build //compiler:sorbet @sorbet_ruby_3_0_for_compiler//:ruby -c opt
./bazel run @sorbet_ruby_3_0_for_compiler//:ruby -c opt -- --version
...
ruby="${repo_root}/bazel-bin/external/sorbet_ruby_3_0_for_compiler/ruby"
