...
# $(rlocation sorbet_ruby_3_0_for_compiler/ruby) here, but when we do that it triggers some
...
# directly to the binary (sorbet_ruby_3_0_for_compiler/toolchain/bin/ruby) instead of the
# shell wrapper (sorbet_ruby_3_0_for_compiler/ruby).
sorbet_ruby="$(dirname "$(rlocation sorbet_ruby_3_0_for_compiler/toolchain/bin/ruby)")"
if ! [[ "$sorbet_ruby" = /* ]]; then
